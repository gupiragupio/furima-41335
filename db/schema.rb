...
ActiveRecord::Schema[7.0].define(version: 2024_11_21_075528) do
  ...
  create_table "addresses", charset: "utf8", force: :cascade do |t|
    ...
    t.index ["order_log_id"], name: "index_addresses_on_order_log_id"
  end
  ...
  create_table "order_logs", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id"], name: "index_order_logs_on_item_id"
  ...
  add_foreign_key "addresses", "order_logs"
  add_foreign_key "items", "users"
  add_foreign_key "order_logs", "items"
